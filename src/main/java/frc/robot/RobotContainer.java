...
import frc.robot.subsystems.AdvantageKitRoller.RollerIOSim;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    if (controller.a().getAsBoolean() == true) {
      advantagekitmotor.motorTester(0.1);
    }
    ...
    // roller.pdpLimit(() -> controller.getRightTriggerAxis(), () ->
   ...
   *
   * <p>return the command to run in autonomous
   */
